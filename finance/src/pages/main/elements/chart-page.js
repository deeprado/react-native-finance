        ...
        <View style={styles.container}>
          <View style={styles.timeSpanGroup}>
            <TouchableHighlight
              ...
              <Text
                style={[
                  this.state.timeSpan === '1D'
                    ? styles.timeSpanSelectedText
                    : styles.timeSpanText,
                ]}>
                {'1D'}
              </Text>
          ...
          <View style={styles.chart}>
            <Image
              style={styles.image}
              source={{
                uri: `https://chart.finance.yahoo.com/z?s=${
                  this.props.stock.symbol
                }&t=${this.state.timeSpan.toLowerCase()}&key=${Math.random()}`,
              }}
            />
          </View>
        </View>
