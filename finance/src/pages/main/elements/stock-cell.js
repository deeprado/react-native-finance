...
class StockCell extends React.Component {
  ...
  render() {
    console.log(
      ...
      this.state.selectedStock.symbol === this.props.stock.symbol,
    );
    return (
      <TouchableHighlight
        style={[
        ...
        onPress={() => this.changeSelectedStock(this.props.stock)}
          ...
          <TouchableHighlight
            style={(() => {
              switch (
                ...
                case true:
                  return styles.changeGreen;
                case false:
                  return styles.changeRed;
                default:
                  return styles.changeGreen;
              }
            })()}
            ...
            onPress={() =>
              StockActions.selectProperty(
                ROTATE_PROPERTIES[this.state.selectedProperty],
              )
            }>
            <View>
